...
@onready var node_reel_03_02 = $"../../Reel/Reel_03-02" as HoboReel_03_02
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_03") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_03_02))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_03_02))
	print("fishing_03 ready")
