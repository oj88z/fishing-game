...
@onready var node_reel_04_03 = $"../../Reel/Reel_04-03" as HoboReel_04_03
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_04") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_04_03))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_04_03))
	print("fishing_04 ready")
