...
@onready var node_reel_02_01 = $"../../Reel/Reel_02-01" as HoboReel_02_01
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_02") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_02_01))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_02_01))
	print("fishing_02 ready")
