...
@onready var node_reel_08_07 = $"../../Reel/Reel_08-07" as HoboReel_08_07
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_08") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_08_07))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_08_07))
	print("fishing_08 ready")
