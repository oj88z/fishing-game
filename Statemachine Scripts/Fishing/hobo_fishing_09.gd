...
@onready var node_reel_09_08 = $"../../Reel/Reel_09-08" as HoboReel_09_08
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_09") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_09_08))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_09_08))
	print("fishing_09 ready")
