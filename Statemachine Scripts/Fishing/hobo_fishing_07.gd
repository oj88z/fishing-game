...
@onready var node_reel_07_06 = $"../../Reel/Reel_07-06" as HoboReel_07_06
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_07") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_07_06))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_07_06))
	print("fishing_07 ready")
