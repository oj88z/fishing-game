...
@onready var node_reel_06_05 = $"../../Reel/Reel_06-05" as HoboReel_06_05
...
func _enter_state() -> void:
	set_process(true)
	animator.play("Fishing_06") # if error: check node in inspector
...
func _on_state_entered():
	if (reel_pressed.is_connected(fsm.change_state.bind(node_reel_06_05))):
		pass
	else:
		reel_pressed.connect(fsm.change_state.bind(node_reel_06_05))
	print("fishing_06 ready")
